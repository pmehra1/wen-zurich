...
<div id="chassis_application_content" class="chassis_application_body">
            ...
            <table summary="four column design layout" class="chassis_three_column_list">
              ...
              <tbody>
                <tr>
                    <td colspan="4">
                        This questionnaire and the strategic asset allocation models are provided by Zurich Life Singapore based on research conducted by Mercer (Singapore) Pte Ltd. ("Mercer"). The results of this questionnaire and the strategic allocation models are derived from information that you have provided to Zurich Life Singapore, and only serve as a reference for your consideration when making your own investment decision. This questionnaire and the results are not an offer to sell or a solicitation for an offer to buy any financial products and services that they should not be considered as investment advice. Zurich Life Singapore and Mercer accept no responsibility or liability as to the accuracy or completeness of the information given in the questionnaire or the results derived therefrom. &nbsp;&nbsp;&nbsp;(How Risk Profile is calculated)
