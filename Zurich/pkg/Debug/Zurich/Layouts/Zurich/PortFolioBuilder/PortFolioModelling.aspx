...
<div id="chassis_application_content" class="chassis_application_body">
    ...
    <table summary="four column design layout" class="chassis_three_column_list">
        ...
        <tr>
            <td colspan="4">
                The information shown contains confidential and proprietary information of Mercer. Any information, opinion, projections and/or ratings expressed or provided is not a guarantee as to the future performance of the investment products/portfolios, asset classes or capital markets discussed. The information takes into account past information which may not be a reliable indicator of future returns. Various factors may arise in the future which may affect the actual returns. It is only provided to illustrate the potential risk and returns of each customer risk profile. It is intended for your general reference only, and it is not to be intended to be investment advice. Neither Mercer, Zurich Life Singapore or your Zurich Adviser accepts any responsibility or liability in connection with your use of such information.
            </td>
        </tr>
        </tbody>
    </table>
